...
const InsightCard = ({imgUrl, title, subtitle, index}) => (
  ...
  >
    <img src={imgUrl} alt={title} className="md:w-[270px] w-full rounded-[32px] object-cover" />
    ...
    <div className="w-full justify-between items-center">
      ...
      <div className="lg:flex hidden items-center justify-center w-[110px] h-[100px] rounded-full bg-transparent border-[1px] border-white">  
